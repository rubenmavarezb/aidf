...
See [Writing AGENTS.md](./agents-file.md) for detailed guidance.
...
- [Writing AGENTS.md](./agents-file.md) - Deep dive into context documents
- [Defining Roles](./roles.md) - Customize AI personas
- [Task Design](./tasks.md) - Write effective tasks
- [Best Practices](./best-practices.md) - Patterns that work
