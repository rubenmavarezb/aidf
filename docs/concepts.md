...
- [Setup Guide](./setup.md) - Integrate AIDF into your project
- [Writing AGENTS.md](./agents-file.md) - Create your context document
- [Defining Roles](./roles.md) - Set up specialized personas
